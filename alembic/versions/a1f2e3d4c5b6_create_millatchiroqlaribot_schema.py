"""create millatchiroqlaribot schema

Revision ID: a1f2e3d4c5b6
Revises: 7af660903cc5
...
down_revision: Union[str, None] = "7af660903cc5"
...
def upgrade() -> None:
    ...
    op.create_table(
        "millatchiroqlaribot_activity_books",
    ...
    op.create_table(
        "millatchiroqlaribot_content_texts",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        "millatchiroqlaribot_score_change_log",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_millatchiroqlaribot_users_referred_by"),
        "millatchiroqlaribot_users",
        ["referred_by"],
        unique=False,
    )
    op.create_index(
        op.f("ix_millatchiroqlaribot_users_telegram_id"),
        "millatchiroqlaribot_users",
        ["telegram_id"],
        unique=True,
    )
    op.create_table(
        "millatchiroqlaribot_zayafka_channels",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("channel_id", sa.BigInteger(), nullable=False),
    ...
    op.create_table(
        "millatchiroqlaribot_test_sessions",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["millatchiroqlaribot_users.id"],
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_millatchiroqlaribot_test_sessions_user_id"),
        "millatchiroqlaribot_test_sessions",
        ["user_id"],
        unique=False,
    )
    op.create_index(
        "ix_millatchiroqlaribot_test_sessions_user_completed_id",
        "millatchiroqlaribot_test_sessions",
        ["user_id", "is_completed", "id"],
        unique=False,
    )
    op.create_table(
        "millatchiroqlaribot_user_zayafka_channels",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("user_id", sa.Integer(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["zayafka_channel_id"],
            ["millatchiroqlaribot_zayafka_channels.id"],
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "user_id",
            "zayafka_channel_id",
            name="uq_millatchiroqlaribot_user_zayafka",
        ),
    )
    op.create_table(
        "millatchiroqlaribot_poll_map",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["session_id"],
            ["millatchiroqlaribot_test_sessions.id"],
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_millatchiroqlaribot_poll_map_poll_id"),
        "millatchiroqlaribot_poll_map",
        ["poll_id"],
        unique=True,
    )
    op.create_index(
        "ix_millatchiroqlaribot_poll_map_session_id",
        "millatchiroqlaribot_poll_map",
        ["session_id"],
        unique=False,
    )
    op.create_table(
        "millatchiroqlaribot_test_answers",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("session_id", sa.Integer(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["question_id"],
            ["millatchiroqlaribot_questions.id"],
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["session_id"],
    ...
    op.create_index(
        op.f("ix_millatchiroqlaribot_test_answers_session_id"),
        "millatchiroqlaribot_test_answers",
        ["session_id"],
        unique=False,
    )
    op.create_index(
        "ix_millatchiroqlaribot_test_answers_session_question",
        "millatchiroqlaribot_test_answers",
...
def downgrade() -> None:
    op.drop_index(
        "ix_millatchiroqlaribot_test_answers_session_question",
        table_name="millatchiroqlaribot_test_answers",
    )
    op.drop_index(
        op.f("ix_millatchiroqlaribot_test_answers_session_id"),
        table_name="millatchiroqlaribot_test_answers",
    )
    op.drop_table("millatchiroqlaribot_test_answers")
    op.drop_index(
        "ix_millatchiroqlaribot_poll_map_session_id",
        table_name="millatchiroqlaribot_poll_map",
    )
    op.drop_index(
        op.f("ix_millatchiroqlaribot_poll_map_poll_id"),
        table_name="millatchiroqlaribot_poll_map",
    )
    op.drop_table("millatchiroqlaribot_poll_map")
    op.drop_table("millatchiroqlaribot_user_zayafka_channels")
    op.drop_index(
        "ix_millatchiroqlaribot_test_sessions_user_completed_id",
        table_name="millatchiroqlaribot_test_sessions",
    )
    op.drop_index(
        op.f("ix_millatchiroqlaribot_test_sessions_user_id"),
        table_name="millatchiroqlaribot_test_sessions",
    )
    op.drop_table("millatchiroqlaribot_test_sessions")
    op.drop_table("millatchiroqlaribot_zayafka_channels")
    op.drop_index(
        op.f("ix_millatchiroqlaribot_users_telegram_id"),
        table_name="millatchiroqlaribot_users",
    )
    op.drop_index(
        op.f("ix_millatchiroqlaribot_users_referred_by"),
        table_name="millatchiroqlaribot_users",
    )
    op.drop_table("millatchiroqlaribot_users")
    op.drop_table("millatchiroqlaribot_score_change_log")
    op.drop_table("millatchiroqlaribot_quiz_settings")
    op.drop_table("millatchiroqlaribot_questions")
    op.drop_table("millatchiroqlaribot_content_texts")
    op.drop_table("millatchiroqlaribot_channels")
    op.drop_table("millatchiroqlaribot_activity_books")
