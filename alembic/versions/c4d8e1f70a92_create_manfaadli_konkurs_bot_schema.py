"""create manfaadli_konkurs_bot schema

Revision ID: c4d8e1f70a92
Revises: a7c3e9f21b48
...
revision: str = "c4d8e1f70a92"
down_revision: Union[str, None] = "a7c3e9f21b48"
...
def upgrade() -> None:
    quiz_type_enum = postgresql.ENUM(
        ...
        "quiz",
        "webapp",
        name="manfaadli_konkurs_bot_quiz_type_enum",
    )
    ...
    op.create_table(
        "manfaadli_konkurs_bot_activity_books",
    ...
    op.create_table(
        "manfaadli_konkurs_bot_channels",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        "manfaadli_konkurs_bot_content_texts",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        "manfaadli_konkurs_bot_questions",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        "manfaadli_konkurs_bot_score_change_log",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_manfaadli_konkurs_bot_users_referred_by"),
        "manfaadli_konkurs_bot_users",
        ["referred_by"],
        unique=False,
    )
    op.create_index(
        op.f("ix_manfaadli_konkurs_bot_users_telegram_id"),
        "manfaadli_konkurs_bot_users",
        ["telegram_id"],
        unique=True,
    )
    op.create_table(
        "manfaadli_konkurs_bot_zayafka_channels",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("channel_id", sa.BigInteger(), nullable=False),
    ...
    op.create_table(
        "manfaadli_konkurs_bot_test_sessions",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["manfaadli_konkurs_bot_users.id"],
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_manfaadli_konkurs_bot_test_sessions_user_id"),
        "manfaadli_konkurs_bot_test_sessions",
        ["user_id"],
        unique=False,
    )
    op.create_index(
        "ix_manfaadli_konkurs_bot_test_sessions_user_completed_id",
        "manfaadli_konkurs_bot_test_sessions",
        ["user_id", "is_completed", "id"],
        unique=False,
    )
    op.create_table(
        "manfaadli_konkurs_bot_user_zayafka_channels",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("user_id", sa.Integer(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["zayafka_channel_id"],
            ["manfaadli_konkurs_bot_zayafka_channels.id"],
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "user_id",
            "zayafka_channel_id",
            name="uq_manfaadli_konkurs_bot_user_zayafka",
        ),
    )
    op.create_table(
        "manfaadli_konkurs_bot_poll_map",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["session_id"],
            ["manfaadli_konkurs_bot_test_sessions.id"],
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_manfaadli_konkurs_bot_poll_map_poll_id"),
        "manfaadli_konkurs_bot_poll_map",
        ["poll_id"],
        unique=True,
    )
    op.create_index(
        "ix_manfaadli_konkurs_bot_poll_map_session_id",
        "manfaadli_konkurs_bot_poll_map",
        ["session_id"],
        unique=False,
    )
    op.create_table(
        "manfaadli_konkurs_bot_test_answers",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("session_id", sa.Integer(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["question_id"],
            ["manfaadli_konkurs_bot_questions.id"],
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["session_id"],
    ...
    op.create_index(
        op.f("ix_manfaadli_konkurs_bot_test_answers_session_id"),
        "manfaadli_konkurs_bot_test_answers",
        ["session_id"],
        unique=False,
    )
    op.create_index(
        "ix_manfaadli_konkurs_bot_test_answers_session_question",
        "manfaadli_konkurs_bot_test_answers",
...
def downgrade() -> None:
    op.drop_index(
        "ix_manfaadli_konkurs_bot_test_answers_session_question",
        table_name="manfaadli_konkurs_bot_test_answers",
    )
    op.drop_index(
        op.f("ix_manfaadli_konkurs_bot_test_answers_session_id"),
        table_name="manfaadli_konkurs_bot_test_answers",
    )
    op.drop_table("manfaadli_konkurs_bot_test_answers")
    op.drop_index(
        "ix_manfaadli_konkurs_bot_poll_map_session_id",
        table_name="manfaadli_konkurs_bot_poll_map",
    )
    op.drop_index(
        op.f("ix_manfaadli_konkurs_bot_poll_map_poll_id"),
        table_name="manfaadli_konkurs_bot_poll_map",
    )
    op.drop_table("manfaadli_konkurs_bot_poll_map")
    op.drop_table("manfaadli_konkurs_bot_user_zayafka_channels")
    op.drop_index(
        "ix_manfaadli_konkurs_bot_test_sessions_user_completed_id",
        table_name="manfaadli_konkurs_bot_test_sessions",
    )
    op.drop_index(
        op.f("ix_manfaadli_konkurs_bot_test_sessions_user_id"),
        table_name="manfaadli_konkurs_bot_test_sessions",
    )
    op.drop_table("manfaadli_konkurs_bot_test_sessions")
    op.drop_table("manfaadli_konkurs_bot_zayafka_channels")
    op.drop_index(
        op.f("ix_manfaadli_konkurs_bot_users_telegram_id"),
        table_name="manfaadli_konkurs_bot_users",
    )
    op.drop_index(
        op.f("ix_manfaadli_konkurs_bot_users_referred_by"),
        table_name="manfaadli_konkurs_bot_users",
    )
    op.drop_table("manfaadli_konkurs_bot_users")
    op.drop_table("manfaadli_konkurs_bot_score_change_log")
    op.drop_table("manfaadli_konkurs_bot_quiz_settings")
    op.drop_table("manfaadli_konkurs_bot_questions")
    op.drop_table("manfaadli_konkurs_bot_content_texts")
    op.drop_table("manfaadli_konkurs_bot_channels")
    op.drop_table("manfaadli_konkurs_bot_activity_books")
