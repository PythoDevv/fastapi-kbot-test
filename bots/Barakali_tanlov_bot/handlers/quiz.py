...
from bots.Barakali_tanlov_bot.services import QuizService, SubsService
from bots.Barakali_tanlov_bot.services.quiz_service import QuestionPayload
from bots.Barakali_tanlov_bot.states import QuizStates
...
async def start_quiz(
    ...
    try:
        ...
        if session_quiz_type == QuizType.WEBAPP:
            ...
            webapp_url = f"{app_settings.BASE_WEBHOOK_URL.rstrip('/')}/barakali_tanlov_bot/webapp/"
            await message.answer(
