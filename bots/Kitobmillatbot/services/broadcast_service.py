...
to Kitobmillatbot's own prefixed tables and gives the handlers a small facade.
"""
from aiogram import Bot
from sqlalchemy import func, select
from sqlalchemy.ext.asyncio import AsyncSession

from bots.Kitobmillatbot.models import BroadcastFailure, BroadcastJob, User
