...
from bots.Kitobmillatbot.services import QuizService
from bots.Kitobmillatbot.webapp.auth import (
    get_token_from_header,
    verify_init_data_and_issue_token,
    verify_token,
)
from bots.Kitobmillatbot.webapp.schemas import (
    AnswerRequest,
    AnswerResponse,
    AuthRequest,
    AuthResponse,
...
router = APIRouter(prefix="/kitobmillatbot/webapp", tags=["kitobmillatbot-webapp"])
