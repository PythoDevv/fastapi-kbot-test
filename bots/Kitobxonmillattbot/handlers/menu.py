...
from bots.Kitobxonmillattbot.repositories import ContentRepository, UserRepository
from bots.Kitobxonmillattbot.services import AuthService, SubsService
from bots.Kitobxonmillattbot.states import AuthStates
...
async def show_books(message: Message, session: AsyncSession) -> None:
    from bots.Kitobxonmillattbot.repositories import BookRepository
