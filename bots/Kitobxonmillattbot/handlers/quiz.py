...
from bots.Kitobxonmillattbot.exceptions import (
    AlreadySolvedError,
    KitobxonError,
...
from bots.Kitobxonmillattbot.services import QuizService, SubsService
from bots.Kitobxonmillattbot.services.quiz_service import QuestionPayload
from bots.Kitobxonmillattbot.states import QuizStates
...
async def start_quiz(
    ...
    try:
        ...
        if session_quiz_type == QuizType.WEBAPP:
            ...
            webapp_url = f"{app_settings.BASE_WEBHOOK_URL.rstrip('/')}/kitobxonmillattbot/webapp/"
            await message.answer(
