...
from bots.Kitobxonmillattbot.models import Channel, Question, ZayafkaChannel
from bots.Kitobxonmillattbot.services.quiz_service import QuestionPayload
...
def content_list_keyboard(contents: list | None = None) -> InlineKeyboardMarkup:
    ...
    from bots.Kitobxonmillattbot.models import ContentText
    buttons = []
    if contents:
        for ct in contents:
            buttons.append(
