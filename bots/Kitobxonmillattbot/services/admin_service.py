...
from bots.Kitobxonmillattbot.cache import runtime_cache
from bots.Kitobxonmillattbot.config import QuizType
from bots.Kitobxonmillattbot.models import ActivityBook, Channel, Question, User, ZayafkaChannel
from bots.Kitobxonmillattbot.repositories import (
    BookRepository,
    ChannelRepository,
    ContentRepository,
    QuizRepository,
...
class AdminService:
    ...
    async def set_score(
        ...
        if user is None:
            from bots.Kitobxonmillattbot.exceptions import UserNotFoundError
