...
from bots.Manfaadli_konkurs_bot.repositories import ContentRepository
from bots.Manfaadli_konkurs_bot.services import AdminService
from bots.Manfaadli_konkurs_bot.states import AdminChannelStates, AdminZayafkaStates
