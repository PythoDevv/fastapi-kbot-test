...
from bots.Manfaadli_konkurs_bot.exceptions import (
    AlreadySolvedError,
    KitobxonError,
...
from bots.Manfaadli_konkurs_bot.services import QuizService, SubsService
from bots.Manfaadli_konkurs_bot.services.quiz_service import QuestionPayload
from bots.Manfaadli_konkurs_bot.states import QuizStates
...
async def start_quiz(
    ...
    try:
        ...
        if session_quiz_type == QuizType.WEBAPP:
            ...
            webapp_url = f"{app_settings.BASE_WEBHOOK_URL.rstrip('/')}/manfaadli_konkurs_bot/webapp/"
            await message.answer(
