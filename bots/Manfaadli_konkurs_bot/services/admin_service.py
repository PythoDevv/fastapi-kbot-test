...
from bots.Manfaadli_konkurs_bot.models import ActivityBook, Channel, Question, User, ZayafkaChannel
...
class AdminService:
    ...
    async def set_score(
        ...
        if user is None:
            from bots.Manfaadli_konkurs_bot.exceptions import UserNotFoundError
