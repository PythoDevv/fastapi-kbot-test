...
to Manfaadli_konkurs_bot's own prefixed tables and gives the handlers a small facade.
"""
from aiogram import Bot
from sqlalchemy import func, select
from sqlalchemy.ext.asyncio import AsyncSession

from bots.Manfaadli_konkurs_bot.models import BroadcastFailure, BroadcastJob, User
