...
from bots.Manfaadli_konkurs_bot.services import QuizService
from bots.Manfaadli_konkurs_bot.webapp.auth import (
    get_token_from_header,
    verify_init_data_and_issue_token,
    verify_token,
)
from bots.Manfaadli_konkurs_bot.webapp.schemas import (
    AnswerRequest,
    AnswerResponse,
    AuthRequest,
    AuthResponse,
...
router = APIRouter(prefix="/manfaadli_konkurs_bot/webapp", tags=["manfaadli_konkurs_bot-webapp"])
...
async def auth(body: AuthRequest):
    telegram_id, token = verify_init_data_and_issue_token(
        body.init_data,
        settings.MANFAADLI_KONKURS_BOT_BOT_TOKEN,
