...
from bots.Millatchiroqlaribot.repositories import ContentRepository, UserRepository
from bots.Millatchiroqlaribot.services import AuthService, SubsService
from bots.Millatchiroqlaribot.states import AuthStates
...
async def show_books(message: Message, session: AsyncSession) -> None:
    from bots.Millatchiroqlaribot.repositories import BookRepository
